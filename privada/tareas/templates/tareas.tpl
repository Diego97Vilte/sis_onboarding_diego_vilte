    ...
    <center>
      <table class="listado">
        ...
        <tr>
          ...
          <td align="center">
            <form name="formModif {$r.id_tarea}" method="post" action="usuario_modificar.php">
          ...
          <td align="center">
            <form name="formElimi {$r.id_tarea}" method="post" action="tarea_eliminar.php">
              <input type="hidden" name="id_tarea" value="{$r.id_tarea}">
              <a href="javascript:document.formElimi {$r.id_tarea}.submit(); " title="Eliminar Tarea" onclick='javascript: return(confirm("Desea realmente Eliminar al gerente ::: {$r.id_tarea}?"));'>
                Eliminar>>
              </a>
            </form>
          </td>
